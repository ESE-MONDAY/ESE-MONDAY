# Hi, I'm Ese Monday
I build infrastructure, then I build the path that gets other developers to understand it.

5+ years writing production code across fintech, telecom, and Web3, Go, Node.js, TypeScript, REST APIs, smart contracts. The last two years, most of that engineering has gone into developer relations: documentation, onboarding pipelines, SDKs, and the occasional live session when a written guide isn't enough.
...
* Open to developer relations, technical writing, and infrastructure-adjacent work global roles.
